...
ggplot(elections_historic, aes(x = popular_pct, y = ec_pct,
  ...
  labs(x = "Winner's share of popular vote", 
       y = "Winner's share of electoral college vote", 
       title = "The electoral college undermines majority-rules democracy", 
       subtitle = "1824-2016",
       caption = "Wilson took advantage of a Republican split, winning 40 states with just 41.8% of the popular vote. \n Adams recieved barely more than 30% of the popular vote but still won the presidency.") # adds a caption
